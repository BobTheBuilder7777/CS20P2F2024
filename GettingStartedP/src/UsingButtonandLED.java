...
public class UsingButtonandLED {
  ...
  public static void main(String[] args) throws Exception{
      ...
      while(true){
          ...
          {
        	  buttonsPressed += 1;
        	  System.out.println("The buttons were pressed: " + buttonsPressed + " times.");
          }
          if ( redButton.getState())
          {
        	  buttonsPressed += 1;
        	  System.out.println("The button were pressed: " + buttonsPressed + " times.");
          }
